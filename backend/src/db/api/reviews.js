...
module.exports = class ReviewsDBApi {
  static async create(data, options) {
    ...
    await reviews.setRacket(data.racket || null, {
      transaction,
    });

    await reviews.setAuthor(data.author || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.racket = await reviews.getRacket({
      transaction,
    });

    output.author = await reviews.getAuthor({
      transaction,
    });
